...
def process_file(file_path, asm_file, header_file, section):
    ...
    with open(asm_file, "a") as asm_f:
        ...
        asm_f.write(f".section .{section}, \"a\"\n")
...
def main():
    ...
    if priority_file:
        ...
        if os.path.isfile(first_file_path):
            process_file(first_file_path, asm_file, header_file, "boot")
    ...
    for root, dirs, files in os.walk(src_dir):
        for file in files:
            ...
            if ext not in extensions:
                continue
            process_file(file_path, asm_file, header_file, "rom")
